...
it("should return initialState", () => {
  ...
  expect(fetchReducer(undefined, takeAction)).toEqual(Map({
    isLoading: false,
    isError: false
  }));
});
...
it("should handle request action", () => {
  ...
  expect(fetchReducer(undefined, requestAction)).toEqual(Map({
    isLoading: true,
    isError: false
  }));
});
...
it("should handle cancel action", () => {
  ...
  expect(fetchReducer(undefined, cancelAction)).toEqual(Map({
    isLoading: false,
    isError: false
  }));
});
...
it("should handle success action", () => {
  ...
  expect(fetchReducer(undefined, successAction)).toEqual(Map({
    isLoading: false,
    isError: false,
...
it("should handle failure action", () => {
  ...
  expect(fetchReducer(undefined, failureAction)).toEqual(Map({
    isLoading: false,
    isError: true,
    error: new Error()
  }));
