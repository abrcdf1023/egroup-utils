...
console.error(
  'Error: useInfiniteScroll is depreciated and it will be removed in next major release. Please use makeInfiniteScroll instead and read doc for more example https://eGroupAI.github.io/egroup-utils.'
);
